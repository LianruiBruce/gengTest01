/*!
 * Project : simply-countup (modified from simply-countdown)
 * File : simplyCountup
 * Date : 27/06/2015
 * License : MIT
 * Version : 1.3.2
    ...
    Array.prototype.forEach.call(cd, function (countdown) {
      ...
      refresh = function () {
        ...
        if (parameters.enableUtc) {
          ...
          secondsElapsed = (nowUtc.getTime() - targetDate.getTime()) / 1000;
        } else {
          secondsElapsed = (now.getTime() - targetDate.getTime()) / 1000;
        }
